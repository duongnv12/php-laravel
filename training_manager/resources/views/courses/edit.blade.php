    ...
    <div class="bg-white p-6 rounded shadow-md">
        <form action="{{ route('courses.update', $course->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.1" name="credit" id="credit"
                       class="mt-1 block w-full border border-gray-300 rounded-md p-2"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description"
                          class="mt-1 block w-full border border-gray-300 rounded-md p-2">{{ old('description', $course->description) }}</textarea>
            </div>
            <div class="mb-4">
                ...
                <select name="prerequisites[]" id="prerequisites"
                    ...
                    @foreach($courses as $courseOption)
                        <option value="{{ $courseOption->id }}"
                            {{ in_array($courseOption->id, old('prerequisites', $course->prerequisites->pluck('id')->toArray())) ? 'selected' : '' }}>
